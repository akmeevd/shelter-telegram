...
#### 1.1 Узнать информацию о приюте. _**(Консультация с новым пользователем)**_
...
#### 1.2 Как взять животное из приюта. _**(Консультация с потенциальным хозяином животного из приюта)**_
...
#### 2. Отправить отчет о питомце. _**(Ведение питомца)**_
